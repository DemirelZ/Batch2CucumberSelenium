...
public class Login_stepDefs {
    ...
    public void the_user_should_be_able_to_login() {
        ...
        System.out.println("I verfy that url changed Dashboard page");
    }
    ...
    public void the_warning_message_contains(String expectedMessage) {
        ...
        String actualMessage = loginPages.getWarningMessageText(expectedMessage);

        Assert.assertEquals("jnkjnjnj",expectedMessage,actualMessage);
    }
